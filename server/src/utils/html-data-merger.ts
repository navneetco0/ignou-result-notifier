export const merge_html = (prev_result, new_result) => `
...
>
  ...
  ${new_result.map(_=>result_to_table(_)).join("")}
</table>
...
>
  ...
  ${prev_result.map(_=>result_to_table(_)).join("")}
  </table>
`;

export const result_to_table = ({
  course_code,
  marks,
  max_marks,
  month_year,
